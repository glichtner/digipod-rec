Instance: PopAdultPatientsPostoperativelyGeneralOnSurgeryDayICU
InstanceOf: recommendation-eligibility-criteria
Usage: #definition
Title: "Population: General Adult Surgical Patients Postoperatively on the Surgery Day on an Intensive Care Unit"
Description: "Adult patients after undergoing an elective surgical intervention of any type independently of the type of anesthesia, on the day of the surgical intervention (from the time of completion of the procedure to midnight), on an intensive care unit."
//* insert canonical-url(covid19-inpatient-therapy, population/ventilated-covid19-patients-fio2-point3)
* status = #draft
* version = "0.2.0"
* date = "2024-04"
* name = "PopAdultPatientsPostoperativelyGeneralOnSurgeryDayICU"
* description = "Population for guideline 0.2 from https://pubmed.ncbi.nlm.nih.gov/37599617/: Adult patients, postoperatively, on the day of the surgical intervention, on an intensive care unit"
