Instance: PopAdultSurgicalPatPreoperativelyWithPositiveMiniCogNeedMMSE
InstanceOf: recommendation-eligibility-criteria
Usage: #definition
Title: "Population: Adult Surgical Patients Preoperatively with Positive Mini-cog Test Score that need a Mini-Mental State Examination"
...
* version = "0.2.0"
* date = "2024-02"
* name = "PopAdultSurgicalPatPreoperativelyWithPositiveMiniCogNeedMMSE"
