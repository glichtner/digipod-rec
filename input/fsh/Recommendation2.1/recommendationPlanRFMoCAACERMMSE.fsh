...
Usage: #definition
Title: "Recommended Plan for Population: Adult Surgical Patients Preoperative with Positive Mini-cog Test Score, check risk factor Montreal Cognitive Assessment (MoCA) score, Addenbrooke's Cognitive Examination revised (ACE-R) score or Mini Mental State Examination (MMSE) score"
...
* action[assessment][+]
  * definitionCanonical = Canonical(RecActionAdultSurgicalPatientsPreoperativeCheckRFACER)
  * code = $sct#386053000 "Evaluation procedure (procedure)"
  * reason = $cs-action-reason-code#risk-assessment "Risk assessment"
  * requiredBehavior = $cs-action-required-behavior#must "Must"
* action[assessment][+]
