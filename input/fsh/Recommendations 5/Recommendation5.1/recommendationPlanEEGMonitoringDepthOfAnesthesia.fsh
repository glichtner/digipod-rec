...
Usage: #definition
Title: "Recommended Plan for Population: Adult Surgical Patients Intraoperative, use Index-based EEG monitoring depth of anaesthesia guidance"
...
* experimental = true
* description = "Recommended Plan for Adult Surgical Patients, Intraoperatively, use Index-based EEG monitoring depth of anaesthesia guidance"
* subjectCanonical = Canonical(PopAdultSurgicalPatientsIntraoperativeGeneral)
