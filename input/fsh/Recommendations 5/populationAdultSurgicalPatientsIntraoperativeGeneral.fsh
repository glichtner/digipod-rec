Instance: PopAdultSurgicalPatientsIntraoperativeGeneral
InstanceOf: recommendation-eligibility-criteria
Usage: #definition
Title: "Population: General Adult Surgical Patients Intraoperative"
...
* version = "0.2.0"
* date = "2024-02"
* name = "PopAdultSurgicalPatientsIntraoperative"
